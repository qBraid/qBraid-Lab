=====================================================
qBraid Lab Migration Guide for IBM Quantum Lab Users
=====================================================
...
.. |IBMQuantumLab| image:: ../_static/ibm_quantum_lab_migration/1-IBM-Quantum-Lab-Sign-In.png
    :width: 80%
...
.. |DownloadData| image:: ../_static/ibm_quantum_lab_migration/2-IBM-Quantum-Lab-Download.png
    :width: 80%
    :target: javascript:void(0);

.. |IBMFiles| image:: ../_static/ibm_quantum_lab_migration/3-IBM-Files-Display.png
    :width: 100%
    :target: javascript:void(0);
...
.. |qBraidLanding| image:: ../_static/ibm_quantum_lab_migration/4-qBraid-Landing.png
    :width: 80%
    :target: javascript:void(0);
...
.. |qBraidSignUp| image:: ../_static/ibm_quantum_lab_migration/5-qBraid-GetStarted.png
    :width: 80%
    :target: javascript:void(0);
...
.. |qBraidLab| image:: ../_static/ibm_quantum_lab_migration/6-qBraid-Lab-Landing.png
    :width: 80%
    :target: javascript:void(0);
...
.. |FilesIcon| image:: ../_static/ibm_quantum_lab_migration/7-qBraid-Lab-Files.png
    :width: 80%
    :target: javascript:void(0);
...
.. |UploadFiles| image:: ../_static/ibm_quantum_lab_migration/8-qBraid-Lab-Upload.png
    :width: 80%
    :target: javascript:void(0);

.. |SelectFiles| image:: ../_static/ibm_quantum_lab_migration/9-qBraid-Lab-Explorer.png
      :width: 80%
      :target: javascript:void(0);

.. |allfiles| image:: ../_static/ibm_quantum_lab_migration/10-qBraid-Lab-AllIn.png
      :width: 80%
      :target: javascript:void(0);
...
Click on the Environments icon in the right panel.
---------------------------------------------------

The qBraid environment is pre-selected, but you have the option to change this.

.. |EnvironmentsIcon| image:: ../_static/ibm_quantum_lab_migration/11-qBraid-Lab-Sample-Enviro.png
    :width: 80%
    :target: javascript:void(0);

.. |EnvironmentsTab| image:: ../_static/ibm_quantum_lab_migration/12-qBraid-Lab-Enviro-Expand.png
    :width: 80%
    :target: javascript:void(0);


Configure your environment with any version of Qiskit you need.
----------------------------------------------------------------
...
.. |QiskitVersion| image:: ../_static/ibm_quantum_lab_migration/13-qBraid-Lab-All-Qiskit.png
    :width: 80%
    :target: javascript:void(0);
